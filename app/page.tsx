...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section className="relative overflow-hidden md:flex md:flex-col md:justify-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-12 pb-8 md:pt-14 md:pb-12 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
      ...
      {/* İSTATİSTİKLER */}
      <section className="py-8 md:py-6 max-w-6xl mx-auto px-6">
      ...
      {/* ONLINE DERSLER */}
      <section className="py-8 md:py-10 max-w-6xl mx-auto px-6">
      ...
      {/* AVANTAJLAR */}
      <section className="bg-[#FAF8F4] py-8 md:py-12">
      ...
      {/* CTA BANNER */}
      <section className="relative py-12 md:py-16 overflow-hidden bg-[#1A1218]">
      ...
      {/* HAKKIMDA */}
      <section className="py-8 md:py-10 max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 md:gap-16 items-center">
