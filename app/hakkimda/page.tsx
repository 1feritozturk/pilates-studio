...
export default function HakkimdaPage() {
  return (
    <>
      ...
      {/* Tanıtım */}
      <section className="py-8 md:py-16 max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 md:gap-16 items-center">
      ...
      {/* Değerler */}
      <section className="bg-[#F5F0F8] py-10 md:py-14">
      ...
      {/* CTA */}
      <section className="py-10 md:py-14 text-center px-6">
        <h2
