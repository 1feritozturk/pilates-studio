...
const fotograflar = [
  {
    ...
    src: '/images/galeri/mat-pilates-dersi.webp',
    span: 'md:col-span-2',
  },
  {
    id: 2,
    baslik: 'Reformer Seansı',
    src: '/images/galeri/reformer-seansi.webp',
    span: '',
  },
  {
    id: 3,
    baslik: 'Grup Dersi',
    src: '/images/galeri/grup-dersi.webp',
    span: '',
  },
  {
    id: 4,
    baslik: 'Esneklik Çalışması',
    src: '/images/galeri/esneklik-calismasi.webp',
    span: '',
  },
  {
    id: 5,
    baslik: 'Core Güçlendirme',
    src: '/images/galeri/core-guclendirme.webp',
    span: '',
  },
  {
    id: 6,
    baslik: 'Denge & Koordinasyon',
    src: '/images/galeri/denge-koordinasyon.webp',
    span: 'md:col-span-2',
  },
  {
    id: 7,
    baslik: 'Özel Ders',
    src: '/images/galeri/ozel-ders.webp',
    span: '',
  },
  {
    id: 8,
    baslik: 'Nefes & Meditasyon',
    src: '/images/galeri/nefes-meditasyon.webp',
    span: '',
  },
];
