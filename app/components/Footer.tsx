    ...
    <footer className="bg-[#1C1C1C] text-[#9E9E9E] py-12 mt-auto">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            <div className="mb-3">
              ...
              <p className="text-xs tracking-[0.12em] text-[#9B7FAD] uppercase">Online Pilates</p>
            </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 text-xs">
          ...
          <Link
            href="/randevu"
            className="px-5 py-2 bg-[#C9A87A] text-white text-sm font-medium rounded-full hover:bg-[#B8976A] transition-colors"
          >
            Derse Kaydol
          </Link>
        </div>
