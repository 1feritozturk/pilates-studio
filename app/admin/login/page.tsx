  ...
  return (
    <div className="min-h-screen bg-[#F5F0F8] px-6 py-12">
      <div className="mx-auto flex min-h-[calc(100vh-6rem)] max-w-6xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-[2rem] border border-[#EDE0F5] bg-white shadow-sm md:grid-cols-[1.05fr_0.95fr]">
          <section className="bg-[#1A1218] px-8 py-10 text-white md:px-12 md:py-14">
            <p className="mb-4 text-xs uppercase tracking-[0.35em] text-[#C4A8BE]">Admin</p>
          ...
          <section className="px-8 py-10 md:px-12 md:py-14">
            ...
            {!isConfigured ? (
              <div className="rounded-3xl border border-[#EDE0F5] bg-[#FAF8F4] p-6 text-sm text-[#6B5E68]">
                <p className="font-medium text-[#1A1218]">Supabase ayarlari eksik.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-[#1A1218]">E-posta</label>
                  <input
                    type="email"
                    required
                    value={email}
                    ...
                    className="w-full rounded-2xl border border-[#EDE0F5] bg-white px-4 py-3 text-sm outline-none transition-colors focus:border-[#9B7FAD]"
                  />
                </div>
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-[#1A1218]">Sifre</label>
                  <input
                    type="password"
                    required
                    value={password}
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-2xl bg-[#9B7FAD] px-5 py-3.5 text-sm font-medium text-white transition-colors hover:bg-[#6B3D7A] disabled:cursor-not-allowed disabled:opacity-70"
                >
